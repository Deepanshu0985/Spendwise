...
import com.finance.common.IdempotencyService;
import com.finance.common.PageMeta;
...
public class TransactionController {
    ...
    public ResponseEntity<?> create(
        ...
        return idempotencyService.executeIdempotent(userId, idempotencyKey, "POST /transactions", HttpStatus.OK, () -> {
            TransactionWithSplits created = transactionService.create(userId, request);
    ...
    public ResponseEntity<?> createTransfer(
        ...
        return idempotencyService.executeIdempotent(userId, idempotencyKey, "POST /transactions/transfer", HttpStatus.OK, () -> {
            TransferService.TransferResult result = transferService.create(userId, request);
    ...
    public ApiResponse<TransactionResponse> update(@PathVariable UUID id, @Valid @RequestBody UpdateTransactionRequest request) {
        TransactionWithSplits updated = transactionService.update(CurrentUserGuard.require(tenantContext), id, request);
