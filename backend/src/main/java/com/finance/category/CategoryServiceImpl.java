...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    @Transactional
    public Category create(UUID userId, CreateCategoryRequest request) {
        Category category = new Category(userId, request.name(), request.categoryType());
    ...
    @Override
    @Transactional
    public Category rename(UUID userId, UUID categoryId, UpdateCategoryRequest request) {
